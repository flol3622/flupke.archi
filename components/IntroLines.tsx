export default function IntroLines() {
  return (
    <>
      <p className="col-span-2 col-start-4 text-center max-sm:text-sm">Coding</p>
      <p className="col-span-2 col-start-6 text-center max-sm:text-sm">Architecture</p>
      <p className="col-span-2 col-start-8 text-center max-sm:text-sm">3D printing</p>
      <p className="col-span-2 col-start-10 text-center max-sm:text-sm">Woodworking</p>
      {/* balls */}
      ...
      <div className="col-span-3 col-start-12 row-span-3 row-start-4 translate-x-[-1px] translate-y-[-2px] rounded-tr-xl border-t-2 border-r-2 border-blue-500" />
